...
String sonuc="";
int soru_puani=0;
ResultSet rs=st.executeQuery("select * from yarismalar where id_y='"+session.getAttribute( "soru_id")+"'"); 
if(rs.next()) 
{ 
	sonuc=rs.getString(6);
	soru_puani=rs.getInt(10);	
}
...
String ekle="insert into yarismalar_cevaplar (id_k,id_y,cevap,durum) values('"+id+"','"+session.getAttribute( "soru_id")+"','"+script +"','"+durum+"');";
