...
<div id="masthead">
                ...
                <div class="row">
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="horizontal-navigation">
                            ...
                            <li class="menu-contact active" itemprop="url"><a href="#" title="Hakkimizda" itemprop="name">Kayıt</a></li>
	  ...
	  <form METHOD=POST ACTION="Profil_ekleme.jsp">
<div class="container">
      <div class="row">
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>İsim:</td>
                        <td> 
              <input type="text" placeholder="İsim" NAME=isim required "></td>
                      </tr>
                       <tr>
                        <td>Soyisim:</td>
                        <td> 
              <input type="text" placeholder="Soyisim" NAME=soyisim required "></td>
                      </tr>
                       <tr>
                        <td>Kullanici Adi:</td>
                        <td> 
              <input type="text" placeholder="Kullanici" NAME=kullaniciadi required "></td>
                      </tr>
                      <tr>
                        <td>Şifre :</td>
                        <td> 
              <input type="text" placeholder="Şifre" NAME=sifre required "></td>
                      </tr>
                      <tr>
                        <td>Okul Adi</td>
                        <td><input type="text" placeholder="okul" NAME=okul required "></td>
                      </tr>    <tr>
                        <td>Cinsiyet</td>
                        <td>
                      ...
                      <tr>
                        <td>Dogum Tarihi</td>
                        <td>
<input type="date" name="tarih" id="dateofbirth"  style="background:#fff url(https://cdn1.iconfinder.com/data/icons/cc_mono_icon_set/blacks/16x16/calendar_2.png)  97% 50% no-repeat ;   border: 1px solid #c4c4c4;border-radius: 5px;background-color: #fff;padding: 3px 5px;box-shadow: inset 0 3px 6px rgba(0,0,0,0.1);width: 190px;"></td>
                      </tr>
                      <tr>
                        <td>Mail</td>
                        <td><input type="mail" placeholder="Kullanici" NAME=mail required ></td>
                      </tr>                 
            ...
            <input type="submit" value="Kayıt ol" class="forms_buttons-action">
                </div>
              </div>
            </div>
