                ...
                <div class="row">
                    ...
                    <nav id="main-menu" role="navigation">
                        <ul class="horizontal-navigation">
                            ...
                            <li class="menu-portfolio active" itemprop="url"><a href="Yarismalar.jsp" title="Yarismalar" itemprop="name">Yarışmalar</a></li>
...
String sorular="";
while(rs.next()) {
	sorular += "<div class=\"three-quarters-block\"><div class=\"content\"><article class=\"post hentry\" itemscope itemprop=\"blogPost\"><header class=\"entry-header\"><h2 class=\"entry-title\" itemprop=\"headline\"><a class=\"fn url\" href=\"Soru_coz.jsp?id="+rs.getString("y.id_y")+"\">" + rs.getString("y.yarisma_adi");
     ...
     sorular += "</span></span><span class=\"post-author\"><i class=\"fa fa-user fa-fw\"></i> Yazar <span class=\"vcard\"><a class=\"fn url\" href=\"profil.jsp?id="+rs.getString("y.id_e")+"\">" + rs.getString("e.isim_e");
