...
String ids=request.getParameter("id"); 
  ...
  System.out.print(ids+"-asklmd-");
  if(session.getAttribute( "editor_id" )!=null){
	  String id= session.getAttribute( "editor_id").toString();
   rs=st.executeQuery("SELECT k.id_s,k.soru_adi,k.soru_icerik,k.girisler,k.cikis,k.kayit_tarihi,e.isim_e,k.yayın_durumu,k.puan FROM unicodes.sorular as k,unicodes.editor as e where k.id_e=e.id_e and k.id_s='"+ids+"'");
              ...
              <div class="row">
                <div class=" col-md-12 col-lg-12 "> 
                  <table class="table table-user-information">
                    ...
                    <form  METHOD=POST ACTION="puan_guncelle_ed.jsp">
