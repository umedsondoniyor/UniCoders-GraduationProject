...
ResultSet rs=st.executeQuery("SELECT soru_adi,soru_icerik,girisler FROM unicodes.onerilen_sorular where id_s='"+id+"';"); 
String sorular="";
while(rs.next()) {
...
<FORM METHOD=POST ACTION="Kontrol_onerilen.jsp">
