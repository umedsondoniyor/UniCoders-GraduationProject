...
<div id="masthead">
  ...
  while(rs.next()) {
	  ...
	  <form METHOD=POST ACTION="Profil_guncelleme.jsp">
<div class="container">
      <div class="row">
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>İsim:</td>
                        <td> 
              <input type="text" placeholder="İsim" NAME=isim required value="<%=rs.getString("isim") %>"></td>
                      </tr>
                       <tr>
                        <td>Soyisim:</td>
                        <td> 
              <input type="text" placeholder="Soyisim" NAME=soyisim required value="<%=rs.getString("soyisim") %>"></td>
                      </tr>
                       <tr>
                        <td>Kullanici Adi:</td>
                        <td> 
              <input type="text" placeholder="Kullanici" NAME=kullaniciadi required value="<%=rs.getString("kullanici_adi") %>"></td>
                      </tr>
                      <tr>
                        <td>Şifre :</td>
                        <td> 
              <input type="text" placeholder="Şifre" NAME=sifre required value="<%=rs.getString("sifre") %>"></td>
                      ...
                      <tr>
                        <td>Okul Adi</td>
                        <td><input type="text" placeholder="okul" NAME=okul required value="<%=rs.getString("okul_adi") %>"></td>
                      </tr>
                      <tr>
                        <td>Dogum Tarihi</td>
                        <td>
<input type="date" name="tarih" id="dateofbirth" value="<%=rs.getString("dogum_tarihi") %>" style="background:#fff url(https://cdn1.iconfinder.com/data/icons/cc_mono_icon_set/blacks/16x16/calendar_2.png)  97% 50% no-repeat ;   border: 1px solid #c4c4c4;border-radius: 5px;background-color: #fff;padding: 3px 5px;box-shadow: inset 0 3px 6px rgba(0,0,0,0.1);width: 190px;"></td>
                      </tr>
                      <tr>
                        <td>Mail</td>
                        <td><input type="mail" placeholder="Kullanici" NAME=mail required value="<%=rs.getString("mail") %>"></td>
                      </tr>                 
