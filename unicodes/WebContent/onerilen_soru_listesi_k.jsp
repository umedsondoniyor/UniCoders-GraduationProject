...
rs=st.executeQuery("SELECT soru_adi,soru_icerik,girisler,Kayit_tarihi FROM unicodes.onerilen_sorular where id_k='"+ id+"';"); 
String sorular="";
while(rs.next()) {
	sorular += "<div class=\"three-quarters-block\"><div class=\"content\"><article class=\"post hentry\" itemscope itemprop=\"blogPost\"><header class=\"entry-header\"><h2 class=\"entry-title\" itemprop=\"headline\">" + rs.getString("soru_adi");
