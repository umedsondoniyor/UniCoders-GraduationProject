		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="input" placeholder="if girisler>1 virgul ile ayir">
				</div>

				<div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Cikis</span>
					<input class="input100" type="text" name="output" placeholder="if cikislar>1 virgul ile ayir">
				</div>
