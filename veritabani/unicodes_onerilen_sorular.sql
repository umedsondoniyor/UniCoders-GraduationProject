...
--
-- Table structure for table `onerilen_sorular`
--

DROP TABLE IF EXISTS `onerilen_sorular`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `onerilen_sorular` (
  `id_s` int(11) NOT NULL AUTO_INCREMENT,
  `soru_adi` varchar(100) CHARACTER SET utf8 COLLATE utf8_turkish_ci DEFAULT NULL,
  ...
  `cikislar` varchar(45) CHARACTER SET utf8 COLLATE utf8_turkish_ci DEFAULT NULL,
  `id_k` int(11) DEFAULT NULL,
  `yatin_durumu` varchar(45) CHARACTER SET utf8 COLLATE utf8_turkish_ci DEFAULT NULL,
